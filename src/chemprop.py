...
if __name__ == "__main__":
    ...
    if args.cyclo:
        ...
        data_path = 'data/juliette/CMD_TS_smiles_ok.csv'
        target_columns = "fw_td_kcalmol"
    ...
    if args.rxnmapper:
        ...
        if args.cmd:
            smiles_columns = 'Int1_to_Int2_SMILES' 

    dataset = next(compress(('cyclo', 'gdb', 'proparg', 'tscmd'), (args.cyclo, args.gdb, args.proparg, args.cmd)))
