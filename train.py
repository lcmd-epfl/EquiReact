...
def train(run_dir, run_name, project, wandb_name, hyper_dict,
    ...
    if dataset=='cyclo':
        ...
        data = GDB722TS(radius=radius, process=process, atom_mapping=atom_mapping, rxnmapper=rxnmapper)
    else:
...
if __name__ == '__main__':
    ...
    train(run_dir, logname, project, args.wandb_name, vars(arg_groups['hyperparameters']), seed=args.seed,
          ...
          two_layers_atom_diff=args.two_layers_atom_diff, rxnmapper=args.rxnmapper)
