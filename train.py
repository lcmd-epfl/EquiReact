...
def parse_arguments():
    ...
    p.add_argument('--max_neighbors', type=int, default=50, help='max number of neighbors')
    ...
    p.add_argument('--distance_emb_dim', type=int, default=48, help='how many gaussian funcs to use')
